...
if mean_val is None:
    mean_val = 0  # or some other default value

if not isinstance(mean_val, (int, float, str)):
    mean_val = str(mean_val)  # convert to string if necessary

mean_val = float(mean_val)  # convert to float
